...
| `persistence/__init__.md` | 生命周期 / 日志 / sqlite 工具等持久化相关测试 |
| `runtime/__init__.md` | 队列、信封、异常、估算器、计数器等基础运行时测试 |
| `stage/__init__.md` | `TaskExecutor`、`TaskStage`、`TaskDispatch` 与内置 stage 相关测试 |
| `benchmark/test_benchmark.md` | `benchmark_graph` / `benchmark_executor` 基准测试 |
| `benchmark/test_clone.md` | clone 工具测试 |
