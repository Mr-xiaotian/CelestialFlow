...
var currentLang: Lang = "zh-CN"; // 当前全局语言，默认使用中文
...
const translations: Record<Lang, Record<string, string>> = {
  "zh-CN": {
    ...
    "injection.insertTermination": "填入终止符模板",
  ...
  en: {
    ...
    "injection.insertTermination": "Fill Termination Template",
  ...
  ja: {
    ...
    "injection.insertTermination": "終了信号テンプレートを入力",
