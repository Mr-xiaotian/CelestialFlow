...
const translations: Record<Lang, Record<string, string>> = {
  ...
  en: {
    ...
    "injection.validationSelectNode":
      "Select a node before editing or validating data",
    ...
    "injection.invalidNodeTaskList":
      "Node {0} must contain a JSON array task list, please fix it first",
  ...
  ja: {
    ...
    "injection.invalidNodeTaskList":
      "ノード {0} のタスクデータは JSON 配列である必要があります。先に修正してください",
