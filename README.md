...
```
📁 CelestialFlow	(226MB 946KB 433B)
    📁 docs         	(34KB 971B)
        📁 reference	(29KB 1022B)
            📝 ctree_client.md  	(6KB 998B)
            📝 go_worker.md     	(6KB 378B)
            📝 task_executor.md 	(7KB 518B)
            📝 task_graph.md    	(4KB 996B)
            📝 task_logging.md  	(0B)
    ...
    📁 src          	(1MB 982KB 236B)
        📁 celestialflow         	(1MB 964KB 10B)
            📁 static     	(1MB 420KB 596B)
                📁 css	(33KB 189B)
                    🎨 base.css     	(7KB 256B)
                    🎨 dashboard.css	(7KB 931B)
                    🎨 errors.css   	(5KB 216B)
                ...
                📁 js 	(35KB 309B)
                    ...
                    📜 task_statuses.js 	(7KB 420B)
                    📜 task_structure.js	(4KB 709B)
                    📜 task_summary.js  	(1KB 131B)
                    📜 task_topology.js 	(1KB 375B)
                    📜 utils.js         	(2KB 294B)
                ❓ favicon.ico	(1MB 352KB 98B)
            📁 templates  	(13KB 723B)
                🌐 index.html	(13KB 723B)
            📁 [1项排除的目录]	(377KB 896B)
            🐍 task_executor.py 	(37KB 115B)
            🐍 task_graph.py    	(25KB 758B)
            🐍 task_logging.py  	(11KB 86B)
            🐍 task_nodes.py    	(10KB 784B)
            🐍 task_progress.py 	(1KB 463B)
            🐍 task_queue.py    	(10KB 28B)
            🐍 task_report.py   	(7KB 382B)
            🐍 task_stage.py    	(8KB 153B)
            🐍 task_structure.py	(7KB 268B)
            🐍 task_tools.py    	(20KB 793B)
            🐍 task_types.py    	(3KB 57B)
            🐍 task_web.py      	(8KB 26B)
            🐍 __init__.py      	(1KB 26B)
        📁 [1项排除的目录]	(18KB 226B)
    📁 tests        	(133KB 145B)
        ...
        🐍 conftest.py      	(51B)
        📝 README.md        	(6KB 339B)
        🐍 test_executor.py 	(3KB 132B)
        🐍 test_graph.py    	(5KB 547B)
        🐍 test_nodes.py    	(11KB 309B)
        🐍 test_structure.py	(10KB 56B)
    📁 [6项排除的目录]	(213MB 140KB 979B)
    ❓ .env          	(88B)
    ❓ .gitignore    	(272B)
    ❓ LICENSE       	(1KB 65B)
    ❓ Makefile      	(501B)
